...
<span id="img00i04" class="img" onclick="imgResize()">![img](/img/Olhovka-techmap.004.jpeg)</span>
...
<span id="img000we3" class="img" onclick="imgResize()">![img](/img/0003-home.jpg)</span>

<span id="img0004" class="img" onclick="imgResize()">![img](/img/0004-home.jpg)</span>
...
<span id="img0we007" class="img" onclick="imgResize()">![img](/img/0007-home.jpeg)</span>
...
<span id="img0h008" class="img" onclick="imgResize()">![img](/img/0008-home.jpg)</span>
...
<span id="img0009" class="img" onclick="imgResize()">![img](/img/0009-home.jpg)</span>
...
<span id="img00ls04" class="img" onclick="imgResize()">![img](/img/0004-home.jpg)</span>
...
### <span style="color: rgb(255, 0, 0);">Выключатель – для чего…
...
<span id="img00ls04" class="img" onclick="imgResize()">![img](/img/0013-home.jpeg)</span>

  Над выключателем установлен регулятор мощности обогрева водопровода ведущего в баню – обозначен синей стрелкой. 

  Протяженность обогревающего кабеля до бани составляет 50м и  при максимальной мощности потребляет до 1500 Вт энергии. Такая мощность совместно с обогревателями дома превышает допустимую нагрузку. Также такая мощность потребления кабелем избыточна, поэтому был установлен регулятор мощности, который ограничивает мощность до 500 Вт, который вполне хватает для того чтобы водопровод не замёрз. Оптимальное положение регулятора, это когда белая метка указывает на  винтик угла прибора – как показано на фото.
