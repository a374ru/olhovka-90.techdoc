...
На утеплёном боксе насосной станции установлен тестовый выключатель. Этот выключатель выполняет свою задачу только при положительных температурах, когда температура воздуха выше 0ºC для принудительного включения обогрева. При отрицательных температурах этот выключатель теряет свою работоспособность.
 ...
 <span id="img00ls04" class="img" onclick="imgResize()">![img](/img/0013-1-home.jpeg)</span>

Нормальное положение выключателя — вниз, то есть отключено. Как указано на фото.

 <span id="img00ls04" class="img" onclick="imgResize()">![img](/img/0013-2-home.jpeg)</span>

  Протяженность обогревающего кабеля до бани составляет 50м и  при максимальной мощности потребляет 600 Вт энергии.
